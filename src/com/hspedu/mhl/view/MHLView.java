...
public class MHLView {
    ...
    //定义一个diningtableservice的属性//菜品类
    private DiningTableService diningTableService = new DiningTableService();
    //定义一个menuservice属性//菜单类
    ...
    public void payBill(){
        ...
        System.out.println("请选择要结账的方式（现金/支付宝/微信）：回车退出");
...
//        System.out.println("=============显示完毕=============");
    ...
    public void orderMenu() {
        ...
        System.out.println("请输入点餐的桌号（-1）：");
        int orderDiningTableId = Utility.readInt();
        if (orderDiningTableId == -1) {
            System.out.println("=============取消点餐=============");
            return;
        }
        System.out.println("请输入点餐的菜品号（-1）：");
        int orderMenuId = Utility.readInt();
        if (orderMenuId == -1) {
            System.out.println("=============取消点餐=============");
            return;
        }
        System.out.println("请输入点餐的菜品量（-1）：");
    ...
    public void orderDiningTable(){
        ...
        char key = Utility.readConfirmSelection();
        if(key == 'Y'){
        //根据orderId返回对应的 Diningtable对象，如果为null，说明该对象不存在
                        ...
                        case "1":
                            ...
                            if (employee != null ){
                                ...
                                while (loop){
                                    ...
                                    System.out.println("\t\t 3 显示菜谱");
                                    System.out.println("\t\t 4 点餐菜单");
